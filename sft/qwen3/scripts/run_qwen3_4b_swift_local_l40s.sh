...
RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_v75_msswift_dp8_lr${LR}_${DUR_TAG}_local_l40s_${RUN_STAMP}}"
...
echo "lr=$LR max_steps=$MAX_STEPS num_epochs=$NUM_EPOCHS save_steps=$SAVE_STEPS"
