...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_miniswe_aligned_passed_65k_reasoning_toolcall_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_miniswe_aligned_passed_65k_reasoning_toolcall_sft}"
