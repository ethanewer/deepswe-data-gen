...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_miniswe_aligned_65k_toolcall_only_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_miniswe_aligned_65k_toolcall_only_sft}"
