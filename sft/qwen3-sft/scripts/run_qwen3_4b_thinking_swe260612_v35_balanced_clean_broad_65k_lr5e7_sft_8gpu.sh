...
# Balanced redo of v34 from the same v27 step49 base. The data root is the
# v34 clean broad mix resharded into similarly sized physical JSONL files so
# online file-level sharding does not overweight the edit-anchor source.
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260612/qwen3-4b-thinking-v35-clean-broad-balanced-prefix-editanchors-mix}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v35_balanced_clean_broad_65k_lr5e7_s300_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v35_balanced_clean_broad_65k_lr5e7_s300_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-93535}"
