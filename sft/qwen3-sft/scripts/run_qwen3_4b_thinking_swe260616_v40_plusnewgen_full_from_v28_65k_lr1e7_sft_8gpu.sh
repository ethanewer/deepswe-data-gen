...
# Conservative latest-source continuation from the strongest measured 4B SFT
# checkpoint. This uses the full mini-swe-aligned passed trajectories, including
# the separate over-65k passed C/C++ rows after prefix-preserving split packing.
# It is primarily an immediate latest-data probe while the heavier
# prefix-weighted latest-source dataset is being built.
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-plus-newgen-063854-miniswe-aligned-passed/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260616_v40_plusnewgen_full_from_v28_65k_lr1e7_s100_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v40_plusnewgen_full_from_v28_65k_lr1e7_s100_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61640}"
