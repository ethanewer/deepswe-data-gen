...
# Base-start pass-last curriculum recipe for the larger 2026-06-17 v5
# compaction-aware mixed25-style view.
#
# Data view:
#   swerebench-v5-compaction-mixed25-passlast-miniswe-aligned
#
...
#   - files are ordered so non-passing/process traces appear first and verified
#     passed traces appear last when shuffle_files=false
#
# Loss policy:
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260617/swerebench-v5-compaction-mixed25-passlast-miniswe-aligned/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260617_v61_v5_mixed25_passlast_process_from_base_65k_lr1e6_s1500_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260617_v61_v5_mixed25_passlast_process_from_base_65k_lr1e6_s1500_assistant_h200_8gpu_sft}"
...
export LR_WARMUP_STEPS="${LR_WARMUP_STEPS:-75}"
...
export DATASET_SEED="${DATASET_SEED:-61761}"
