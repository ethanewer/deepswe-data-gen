...
The intended training script in `deepswe-data-gen` is:

```bash
sft/qwen3-sft/scripts/run_qwen3_4b_thinking_swe260617_v75_hf_processed_from_base_65k_lr1e6_sft_8gpu.sh
```
