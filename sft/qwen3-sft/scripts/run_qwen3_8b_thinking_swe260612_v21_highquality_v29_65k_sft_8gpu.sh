...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260612/qwen3-4b-thinking-v21-highquality-v29-strongagentic-mix}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_8b_thinking_swe260612_v21_highquality_v29_contextguard_65k_s300_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_8b_thinking_swe260612_v21_highquality_v29_contextguard_65k_s300_assistant_h200_8gpu_sft}"
