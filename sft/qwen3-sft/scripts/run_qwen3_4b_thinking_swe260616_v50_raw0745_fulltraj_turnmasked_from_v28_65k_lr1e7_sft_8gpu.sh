...
# Corrected raw0745 continuation recipe.
#
# This intentionally trains on complete Mini-SWE-aligned trajectories, not
# prefix-expanded single-turn rows. The qwen3_thinking_acc.jinja2 template keeps
# assistant reasoning in the rendered context, so prefix expansion is unnecessary
# and can distort the train/eval distribution. Bad assistant targets are handled
# by per-turn masking in the online packer while the full trajectory remains
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-rawplus-exact-0745-miniswe-aligned-passed-quality/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260616_v50_raw0745_fulltraj_turnmasked_from_v28_65k_lr1e7_s100_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v50_raw0745_fulltraj_turnmasked_from_v28_65k_lr1e7_s100_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61650}"
