...
# Main latest-source candidate: continue from the best measured 4B v28
# checkpoint using a rebuilt prefix-weighted view of the plus-newgen source.
# The data root should be a single shuffled weighted JSONL so indexed online
# row-shuffle remains active during short SFT runs.
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-plus-newgen-063854-miniswe-passed-prefix-weighted-v2/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260616_v41_plusnewgen_prefixweighted_from_v28_65k_lr1e7_s150_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v41_plusnewgen_prefixweighted_from_v28_65k_lr1e7_s150_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61641}"
