...
# 1,048,576 packed tokens/update; 1200 steps is ~98.9% of the
# 1,272,039,599-token Qwen3-tokenized source.
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v27_highquality_exact_rowshuffle_contextguard_131k_lr1p5e6_s1200_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v27_highquality_exact_rowshuffle_contextguard_131k_lr1p5e6_s1200_assistant_h200_8gpu_sft}"
...
# Keep overlength rows split, not truncated: about 2% of rows are above 131k,
