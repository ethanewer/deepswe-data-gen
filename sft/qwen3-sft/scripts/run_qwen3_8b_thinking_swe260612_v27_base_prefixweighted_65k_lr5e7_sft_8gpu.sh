...
# 8B base-start port of the best 4B v28 corrective recipe. Unlike v25/v26,
# this starts directly from the prepared Qwen3-VL-8B text checkpoint rather
# than from an earlier full-source 8B SFT checkpoint.
