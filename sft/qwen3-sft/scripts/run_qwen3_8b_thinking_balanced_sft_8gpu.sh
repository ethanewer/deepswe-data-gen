...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260612/qwen3-4b-thinking-prefix-weighted-v10-balancededit-mix}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_8b_thinking_swe260612_prefix_weighted_v10_balancededit_65k_assistant_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_8b_thinking_swe260612_prefix_weighted_v10_balancededit_65k_assistant_sft}"
