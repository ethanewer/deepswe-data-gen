...
# Base-start mixed-quality recipe for the 2026-06-16 20:30 raw2030 source.
#
# Data view:
...
#   - an equal number of high-quality non-passing rows selected by
#     build_swerebench_mixed_passrate_allowlists.py
#   - non-passing rows must still be submitted, non-empty-patch,
#     high-reasoning structural traces; infra, empty-patch, not-submitted,
#     low-reasoning, huge-patch, and huge-trajectory rows are excluded
#
# Loss policy:
#   - keep full trajectories in context
#   - do not use prefix expansion
#   - mask unsafe assistant targets online, including manual patch targets,
#     unverified submit targets, and submit targets from non-passing rows
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-raw2030-targeted-limitations-mixed50-miniswe-aligned/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260616_v55_raw2030_mixed50_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v55_raw2030_mixed50_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61655}"
