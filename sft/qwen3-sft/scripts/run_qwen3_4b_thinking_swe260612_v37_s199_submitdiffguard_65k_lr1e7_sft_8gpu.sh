...
# Low-LR corrective SFT from the best v28 checkpoint. The code-side loss policy
# now only trains submit targets after visible unified-diff output, which should
# reduce empty/malformed final submissions without introducing recovery data.
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v37_s199_submitdiffguard_65k_lr1e7_s150_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v37_s199_submitdiffguard_65k_lr1e7_s150_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-93737}"
