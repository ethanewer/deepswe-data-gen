...
export CONFIG="${CONFIG:-configs/qwen3_4b_thinking_swe260617_v73_mixed50_weighted_one_epoch_65k_sft_8gpu.yaml}"
export MODEL="${MODEL:-Qwen/Qwen3-4B-Thinking-2507}"
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260617/swerebench-v5only-compaction-mixed50-cleanpatch-provenance-miniswe-aligned/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260617_v73_mixed50_weighted_one_epoch_65k_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260617_v73_mixed50_weighted_one_epoch_65k_sft}"
