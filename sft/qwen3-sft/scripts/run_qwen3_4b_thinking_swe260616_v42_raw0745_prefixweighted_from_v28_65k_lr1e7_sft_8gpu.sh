...
# Strict 07:45 raw-source candidate: continue from the strongest measured 4B
# v28 checkpoint on a metadata-quality-filtered, mini-swe-aligned,
# prefix-weighted view of the latest raw source. This keeps the v37/v41
# low-LR corrective shape while adding the newly accepted local/generated C/C++
# and exact-source traces.
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-rawplus-exact-0745-miniswe-passed-prefix-weighted-v1/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260616_v42_raw0745_prefixweighted_from_v28_65k_lr1e7_s200_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v42_raw0745_prefixweighted_from_v28_65k_lr1e7_s200_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61642}"
