...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260616_v56_raw2030_mixed50_submit_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v56_raw2030_mixed50_submit_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61656}"
