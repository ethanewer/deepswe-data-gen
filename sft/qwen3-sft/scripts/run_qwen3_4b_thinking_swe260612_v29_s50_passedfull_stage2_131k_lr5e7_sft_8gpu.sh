...
# Stage-2 corrective SFT from v27 step-50 using only complete passed
# mini-swe-agent-aligned trajectories. The dataset is small, so this is kept
# short to avoid heavy repetition while testing whether passed full traces
