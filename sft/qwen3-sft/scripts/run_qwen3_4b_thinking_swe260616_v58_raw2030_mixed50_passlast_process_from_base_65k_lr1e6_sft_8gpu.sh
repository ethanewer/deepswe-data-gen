...
# Base-start pass-last curriculum recipe for the 2026-06-16 20:30 raw2030 source.
#
# Data view:
#   swerebench-raw2030-targeted-limitations-mixed50-passlast-miniswe-aligned
#
# Selection/order policy:
#   - same rows as the mixed50 view: strict passed rows plus ranked high-quality
#     non-passing rows selected by build_swerebench_mixed_passrate_allowlists.py
...
#     terminal patches while v56 tests the more aggressive submit-supervised path
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260616/swerebench-raw2030-targeted-limitations-mixed50-passlast-miniswe-aligned/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260616_v58_raw2030_mixed50_passlast_process_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260616_v58_raw2030_mixed50_passlast_process_from_base_65k_lr1e6_s750_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61658}"
