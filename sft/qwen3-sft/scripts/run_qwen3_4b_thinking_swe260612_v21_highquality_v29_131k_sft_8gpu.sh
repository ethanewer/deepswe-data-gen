...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v21_highquality_v29_contextguard_131k_s300_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v21_highquality_v29_contextguard_131k_s300_assistant_h200_8gpu_sft}"
