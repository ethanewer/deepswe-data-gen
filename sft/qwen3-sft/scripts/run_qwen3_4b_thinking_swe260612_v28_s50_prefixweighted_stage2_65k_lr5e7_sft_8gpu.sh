...
# Stage-2 corrective SFT from the best full-mix checkpoint seen so far.
# v27 step-50 scored 3/30 on the multilingual subset, while longer full-mix
# training regressed. This run keeps that initialization and trains briefly on
# passed-only prefix targets, avoiding additional failed-trajectory imitation.
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v28_s50_prefixweighted_stage2_65k_lr5e7_s200_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v28_s50_prefixweighted_stage2_65k_lr5e7_s200_assistant_h200_8gpu_sft}"
