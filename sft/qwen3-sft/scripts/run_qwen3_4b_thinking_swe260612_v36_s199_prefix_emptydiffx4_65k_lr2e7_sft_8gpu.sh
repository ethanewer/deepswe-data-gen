...
# Targeted low-LR correction from the best prior v28 checkpoint. The data keeps
# the passed-prefix distribution and adds explicit empty-diff recovery rows.
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260612/qwen3-4b-thinking-v36-v28-prefix-emptydiffx4-balanced-mix}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v36_s199_prefix_emptydiffx4_65k_lr2e7_s150_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v36_s199_prefix_emptydiffx4_65k_lr2e7_s150_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-93636}"
