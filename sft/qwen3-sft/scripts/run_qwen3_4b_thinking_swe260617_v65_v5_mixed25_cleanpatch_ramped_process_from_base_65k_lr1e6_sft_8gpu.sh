...
# mixed25-style view after dropping whole trajectories that hand-assemble patch.txt.
#
# Data view:
...
#   - include recommended v5 compactions and the highest-ranked non-passing rows
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260617_v65_v5_mixed25_cleanpatch_ramped_process_from_base_65k_lr1e6_s2200_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260617_v65_v5_mixed25_cleanpatch_ramped_process_from_base_65k_lr1e6_s2200_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61765}"
