...
# Broader continuation from the best 4B checkpoint so far (v28 step199).
# v31 isolates patch.txt verification behavior; this variant tests the other
# direction: keep the working v28 policy, expose it to more unique high-quality
# source traces, and use 131k packs so long rows are split less often.
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v32_s50_v28_full131k_lr2e7_s150_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v32_s50_v28_full131k_lr2e7_s150_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-93232}"
