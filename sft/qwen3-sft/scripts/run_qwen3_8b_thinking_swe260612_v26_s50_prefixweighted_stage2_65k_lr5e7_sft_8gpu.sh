...
# 8B port of the 4B v28 corrective stage. Start from the early full-mix
# checkpoint and train on passed-only prefix targets, which gave the best
# 4B multilingual result without imitating failed trajectories further.
...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_8b_thinking_swe260612_v26_s50_prefixweighted_stage2_65k_lr5e7_s200_assistant_h200_8gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_8b_thinking_swe260612_v26_s50_prefixweighted_stage2_65k_lr5e7_s200_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-56565}"
