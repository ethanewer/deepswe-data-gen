...
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen3_4b_thinking_swe260612_v23_highquality_exact_contextguard_65k_s75_assistant_h200_4gpu_sft/}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260612_v23_highquality_exact_contextguard_65k_s75_assistant_h200_4gpu_sft}"
