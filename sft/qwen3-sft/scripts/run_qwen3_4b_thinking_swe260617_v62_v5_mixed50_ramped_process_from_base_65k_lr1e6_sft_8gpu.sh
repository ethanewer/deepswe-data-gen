...
# Base-start ramped-passrate curriculum recipe for the 2026-06-17 v5
# compaction-aware mixed50 view.
#
# Data view:
...
#     provenance sidecars
#   - add ranked high-quality non-passing rows to reach about 50% passrate
#   - sorted shards ramp from about 20% passed to about 79% passed
...
export TRAIN_RAW_ROOT="${TRAIN_RAW_ROOT:-/wbl-fast/usrs/ee/code-swe-data/data/new-synthetic-data/260617/swerebench-v5-compaction-mixed50-ramped-miniswe-aligned/data}"
export CHECKPOINT_DIR="${CHECKPOINT_DIR:-/scratch/ewer/qwen3-sft-local/outputs/qwen3_4b_thinking_swe260617_v62_v5_mixed50_ramped_process_from_base_65k_lr1e6_s1200_assistant_h200_8gpu_sft}"
export RUN_NAME="${RUN_NAME:-qwen3_4b_thinking_swe260617_v62_v5_mixed50_ramped_process_from_base_65k_lr1e6_s1200_assistant_h200_8gpu_sft}"
...
export DATASET_SEED="${DATASET_SEED:-61762}"
