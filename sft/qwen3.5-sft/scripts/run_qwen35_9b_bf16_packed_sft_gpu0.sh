...
CONFIG="${CONFIG:-configs/qwen35_9b_bf16_packed_sft_single_gpu.yaml}"
TRAIN_DATA="${TRAIN_DATA:-data/smoke_train.jsonl}"
VAL_DATA="${VAL_DATA:-data/smoke_val.jsonl}"
PACK_SIZE="${PACK_SIZE:-32768}"
SEQ_LENGTH="${SEQ_LENGTH:-4096}"
MAX_STEPS="${MAX_STEPS:-10}"
CHECKPOINT_DIR="${CHECKPOINT_DIR:-checkpoints/qwen35_9b_bf16_packed_sft/}"
